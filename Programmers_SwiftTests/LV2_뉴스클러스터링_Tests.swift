...
class LV2_뉴스클러스터링_Tests: XCTestCase {
    ...
    func testCase2() {
        // 1. given
        testCase = TestCase(str1: "handshake", str2: "shake hands", output: 65536)
    ...
    func testCase3() {
        // 1. given
        testCase = TestCase(str1: "aa1+aa2", str2: "AAAA12", output: 43690)
    ...
    func testCase4() {
        // 1. given
        testCase = TestCase(str1: "E=M*C^2", str2: "e=m*c^2", output: 16384)
